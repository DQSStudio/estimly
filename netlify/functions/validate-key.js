...
export default async (req) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ valid: true, customer: record.customer, aiEnabled: !!record.aiEnabled, followupEnabled: !!record.followupEnabled, costCalcEnabled: !!record.costCalcEnabled, suiteEnabled: !!record.suiteEnabled }), {
      status: 200,
      headers: { 'Content-Type': 'application/json' }
    });
  } catch (err) {
